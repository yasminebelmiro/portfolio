...
const ExperienceList = [
  {
    id: 1,
    name: "Estagiária em React | Compass UOL 03/2025 - Atual",
    description:
      "Desenvolvimento ágil com Scrum e boas práticas de segurança na web. Programação com JavaScript e TypeScript, versionamento eficiente de código. Construção de aplicações escaláveis com React, Redux e React Router. Documentação de componentes com Storybook e uso de Design Systems. Exploração de serviços AWS e preparação para certificação AWS.",
  },
  {
    id: 2,
    name: "Desenvolvedora Front-end | Projeto de extensão Desconto Direto 02/2023 - Atual",
    description:
